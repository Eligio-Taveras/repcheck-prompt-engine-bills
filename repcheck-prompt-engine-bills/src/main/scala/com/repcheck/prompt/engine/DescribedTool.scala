...
/**
 * An injected code [[LlmTool]] with only its model-facing description replaced by the GCS block — everything else
 * (decode/execute/encode, and the codec-derived schemas + examples) delegates unchanged. This is how a profile tunes
